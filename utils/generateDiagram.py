...
def generateDiagram(segments, outputPath="./railSim/railSimulator/static/img/diagrama.png"):
    ...
    est_to_y = {e: i for i,e in enumerate(stationlist)}
    fig, ax = plt.subplots(figsize=(12,6))
    ax.set_xticks(range(len(stationlist)))
    ax.set_xticklabels(stationlist)
